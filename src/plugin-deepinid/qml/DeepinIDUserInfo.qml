            ...
            DccObject {
                ...
                page: Button {
                    ...
                    onClicked: {
                        ...
                        clearLoader.sourceComponent = comfirmClearDialog
                        clearLoader.active = true
                    }
                    Loader {
                        id: clearLoader
                        active: false
                        onLoaded: function () {
                            clearLoader.item.show()
                        }
                    }

                    Component {
                        id: comfirmClearDialog
                        ComFirmClearDialog {
                            onClosing: function (close) {
                                clearLoader.active = false
                            }
                            onRequestClear: {
                                console.log("---------------onRequestClear")
                                if (dccData.worker.checkPasswdEmpty()) {
                                    clearLoader.sourceComponent = registerDialog
                                } else {
                                    clearLoader.sourceComponent = verifyDialog
                                }
                            }
                        }
                    }
